...
public class CreateCourseAndReviewsDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			c1.addReview(new Review("Great course, Java is ok"));
			c1.addReview(new Review("Fantastic job, well done!"));
			c1.addReview(new Review("Oh my god, great job"));
			c1.addReview(new Review("OK, when part 2? I need more information about this language. Java is the best"));
			c1.addReview(new Review("Superb, fantastic :)"));
			c1.addReview(new Review("Dump course, you are an idiot!"));
